            ...
            child: StreamBuilder<UserData>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    final bmi = (weight / (pow(((feet * 12) + inches), 2))) *
                        703;
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Table(
                                                    ...
                                                    columnWidths: {0: FlexColumnWidth(0.34), 1: FlexColumnWidth(0.40)},
                                                    children: [
                                                      TableRow(
                                                          children: [
                                                            Container(
