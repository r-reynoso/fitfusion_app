...
class MondayDiet extends StatefulWidget {
  @override
  _MondayDietState createState() => _MondayDietState();
}

class _MondayDietState extends State<MondayDiet> {
  double size = 20.0;
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(dietData.mondayDiet,
